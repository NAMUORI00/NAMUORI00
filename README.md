...
<details>
  ...
  - [steipete/oracle](https://github.com/steipete/oracle) ⭐ 1,812<br/><sub>Ask the oracle when you're stuck. Invoke GPT-5 Pro with a custom context and ...</sub>
  - [GreenSheep01201/claw-empire](https://github.com/GreenSheep01201/claw-empire) ⭐ 1,037<br/><sub>Command Your AI Agent Empire from the CEO Desk — A local-first AI agent offic...</sub>
  - [FareedKhan-dev/all-agentic-architectures](https://github.com/FareedKhan-dev/all-agentic-architectures) ⭐ 3,011<br/><sub>Implementation of 17+ agentic architectures designed for practical use across...</sub>
  - [patchy631/ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub) ⭐ 33,270<br/><sub>In-depth tutorials on LLMs, RAGs and real-world AI agent applications.</sub>
</details>
...
<details>
  ...
  - [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) ⭐ 17,683<br/><sub>A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workf...</sub>
</details>

<details>
  <summary><b>🎧 Voice, Media & Tools</b></summary>

  - [killkimno/MORT](https://github.com/killkimno/MORT) ⭐ 1,467<br/><sub>MORT 번역기 프로젝트 - Real-time game translator with OCR</sub>
...
<details>
  ...
  - [typst/typst](https://github.com/typst/typst) ⭐ 52,506<br/><sub>A markup-based typesetting system that is powerful and easy to learn.</sub>
  - [terrastruct/d2](https://github.com/terrastruct/d2) ⭐ 23,374<br/><sub>D2 is a modern diagram scripting language that turns text to diagrams.</sub>
  - [DavidHDev/react-bits](https://github.com/DavidHDev/react-bits) ⭐ 37,690<br/><sub>An open source collection of animated, interactive & fully customizable React...</sub>
...
<details>
  ...
  - [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 10,046<br/><sub>Unofficial revival of the well known .NET debugger and assembly editor, dnSpy</sub>
