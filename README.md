...
<details>
  ...
  - [FareedKhan-dev/all-agentic-architectures](https://github.com/FareedKhan-dev/all-agentic-architectures) ⭐ 2,647<br/><sub>Implementation of 17+ agentic architectures designed for practical use across...</sub>
  - [patchy631/ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub) ⭐ 30,827<br/><sub>In-depth tutorials on LLMs, RAGs and real-world AI agent applications.</sub>
  - [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 5,862<br/><sub>AI-powered reverse engineering assistant that bridges IDA Pro with language m...</sub>
  - [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) ⭐ 28,787<br/><sub>[EMNLP2025] "LightRAG: Simple and Fast Retrieval-Augmented Generation"</sub>
</details>
...
<details>
  ...
  - [KernelErr/dnSpy.Extension.MCP](https://github.com/KernelErr/dnSpy.Extension.MCP) ⭐ 45<br/><sub>MCP extension for dnSpy.</sub>
  - [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) ⭐ 14,070<br/><sub>A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workf...</sub>
...
<details>
  ...
  - [killkimno/MORT](https://github.com/killkimno/MORT) ⭐ 1,430<br/><sub>MORT 번역기 프로젝트 - Real-time game translator with OCR</sub>
...
<details>
  ...
  - [typst/typst](https://github.com/typst/typst) ⭐ 51,653<br/><sub>A markup-based typesetting system that is powerful and easy to learn.</sub>
  - [terrastruct/d2](https://github.com/terrastruct/d2) ⭐ 23,129<br/><sub>D2 is a modern diagram scripting language that turns text to diagrams.</sub>
  - [DavidHDev/react-bits](https://github.com/DavidHDev/react-bits) ⭐ 36,215<br/><sub>An open source collection of animated, interactive & fully customizable React...</sub>
  - [bokeh/bokeh](https://github.com/bokeh/bokeh) ⭐ 20,358<br/><sub>Interactive Data Visualization in the browser, from  Python</sub>
</details>

<details>
  <summary><b>💡 기타 관심사</b></summary>

  - [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 9,824<br/><sub>Unofficial revival of the well known .NET debugger and assembly editor, dnSpy</sub>
  - [es3n1n/defendnot](https://github.com/es3n1n/defendnot) ⭐ 3,245<br/><sub>An even funnier way to disable windows defender. (through WSC api)</sub>
</details>
<!-- END_SECTION:stars -->
