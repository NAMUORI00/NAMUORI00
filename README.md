...
<details>
  ...
  - [google-research/timesfm](https://github.com/google-research/timesfm) ⭐ 19,344<br/><sub>TimesFM (Time Series Foundation Model) is a pretrained time-series foundation...</sub>
  - [mattmireles/gemma-tuner-multimodal](https://github.com/mattmireles/gemma-tuner-multimodal) ⭐ 1,406<br/><sub>Fine-tune Gemma 4 and 3n with audio, images and text on Apple Silicon, using ...</sub>
  - [steipete/oracle](https://github.com/steipete/oracle) ⭐ 2,178<br/><sub>Ask the oracle when you're stuck. Invoke GPT-5 Pro with a custom context and ...</sub>
...
<details>
  ...
  - [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) ⭐ 19,518<br/><sub>A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workf...</sub>
</details>

<details>
  <summary><b>🎧 Voice, Media & Tools</b></summary>

  - [killkimno/MORT](https://github.com/killkimno/MORT) ⭐ 1,501<br/><sub>MORT 번역기 프로젝트 - Real-time game translator with OCR</sub>
...
<details>
  ...
  - [typst/typst](https://github.com/typst/typst) ⭐ 53,265<br/><sub>A markup-based typesetting system that is powerful and easy to learn.</sub>
  - [terrastruct/d2](https://github.com/terrastruct/d2) ⭐ 23,615<br/><sub>D2 is a modern diagram scripting language that turns text to diagrams.</sub>
  - [DavidHDev/react-bits](https://github.com/DavidHDev/react-bits) ⭐ 38,810<br/><sub>An open source collection of animated, interactive & fully customizable React...</sub>
...
<details>
  ...
  - [p-e-w/heretic](https://github.com/p-e-w/heretic) ⭐ 20,421<br/><sub>Fully automatic censorship removal for language models</sub>
  - [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 10,177<br/><sub>Unofficial revival of the well known .NET debugger and assembly editor, dnSpy</sub>
</details>
<!-- END_SECTION:stars -->
