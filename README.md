...
<details>
  ...
  - [google-research/timesfm](https://github.com/google-research/timesfm) ⭐ 18,408<br/><sub>TimesFM (Time Series Foundation Model) is a pretrained time-series foundation...</sub>
  - [mattmireles/gemma-tuner-multimodal](https://github.com/mattmireles/gemma-tuner-multimodal) ⭐ 1,380<br/><sub>Fine-tune Gemma 4 and 3n with audio, images and text on Apple Silicon, using ...</sub>
  - [steipete/oracle](https://github.com/steipete/oracle) ⭐ 2,013<br/><sub>Ask the oracle when you're stuck. Invoke GPT-5 Pro with a custom context and ...</sub>
  - [GreenSheep01201/claw-empire](https://github.com/GreenSheep01201/claw-empire) ⭐ 1,097<br/><sub>Command Your AI Agent Empire from the CEO Desk — A local-first AI agent offic...</sub>
</details>
...
<details>
  ...
  - [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) ⭐ 18,621<br/><sub>A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workf...</sub>
</details>
...
<details>
  ...
  - [typst/typst](https://github.com/typst/typst) ⭐ 52,973<br/><sub>A markup-based typesetting system that is powerful and easy to learn.</sub>
  - [terrastruct/d2](https://github.com/terrastruct/d2) ⭐ 23,569<br/><sub>D2 is a modern diagram scripting language that turns text to diagrams.</sub>
  - [DavidHDev/react-bits](https://github.com/DavidHDev/react-bits) ⭐ 38,638<br/><sub>An open source collection of animated, interactive & fully customizable React...</sub>
  - [bokeh/bokeh](https://github.com/bokeh/bokeh) ⭐ 20,383<br/><sub>Interactive Data Visualization in the browser, from  Python</sub>
</details>
...
<details>
  ...
  - [p-e-w/heretic](https://github.com/p-e-w/heretic) ⭐ 19,780<br/><sub>Fully automatic censorship removal for language models</sub>
  - [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ⭐ 10,128<br/><sub>Unofficial revival of the well known .NET debugger and assembly editor, dnSpy</sub>
</details>
<!-- END_SECTION:stars -->
